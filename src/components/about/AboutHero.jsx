  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 65% 65% at 50% 55%, rgba(59,31,15,0.45) 0%, rgba(201,168,76,0.04) 50%, transparent 75%)',
        }}
      />
      ...
      >
        ...
        <motion.nav variants={item} className="flex items-center justify-center gap-1.5 mb-8">
          ...
          <span className="text-[9px] tracking-[0.35em] uppercase text-gold-400/50">About</span>
        </motion.nav>
        ...
        <motion.h1 variants={item} className="font-heading leading-tight mb-4">
          <span className="text-5xl md:text-7xl text-ivory block" style={{ fontWeight: 300 }}>Our</span>
          <span className="text-5xl md:text-7xl italic text-gold-gradient block" style={{ fontWeight: 400 }}>Story</span>
        </motion.h1>
        ...
        <motion.p variants={item} className="font-heading italic text-ivory/30 text-base md:text-lg max-w-sm mx-auto">
