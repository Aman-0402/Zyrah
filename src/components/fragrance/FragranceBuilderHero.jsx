...
const PARTICLES = [
  ...
  { left: '44%', top: '14%', dur: 10, del: 1.8, size: 1 },
  { left: '91%', top: '50%', dur: 7,  del: 3.0, size: 1 },
  { left: '4%',  top: '52%', dur: 9,  del: 0.4, size: 1.5 },
  { left: '58%', top: '78%', dur: 8,  del: 2.0, size: 1 },
]
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-1/3 w-[600px] h-[400px] pointer-events-none" style={{
        background: 'radial-gradient(ellipse, rgba(80,40,10,0.10) 0%, transparent 65%)',
        filter: 'blur(60px)',
      }} />
      <div className="absolute bottom-0 right-1/3 w-[500px] h-[300px] pointer-events-none" style={{
        background: 'radial-gradient(ellipse, rgba(60,30,8,0.08) 0%, transparent 65%)',
        filter: 'blur(60px)',
      }} />
